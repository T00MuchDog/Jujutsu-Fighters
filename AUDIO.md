...
| `sfx/battle/cursed_speech.wav` | A Cursed Speech move activation (stable move IDs `000065`–`000072` and `000128`) |
...
Impact Sounds pack and the Cursed Speech cue is sourced from qubodup's CC0
collection; both are intentionally not overwritten by the generator. See
`graphics/src/main/resources/assets/audio/SFX_PROVENANCE.md` for provenance.
The Cursed Speech cue is a short CC0 synthesized dark/voice-like effect from
qubodup's *3 dark magic spells* collection; it is not an anime sample or a
voice clone. Its source and conversion details are documented in the provenance
file.
