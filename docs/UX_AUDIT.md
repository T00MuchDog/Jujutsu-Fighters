...
Completed: **S05** now starts with 1v1 visibly selected, using a persistent
`SELECTED` label and highlighted card. Right/Down advances to 2v2 on the first
press, pointer hover preserves the selected format, and Enter confirms it.
