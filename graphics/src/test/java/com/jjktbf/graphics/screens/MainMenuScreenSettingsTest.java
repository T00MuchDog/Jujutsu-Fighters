...
class MainMenuScreenSettingsTest {
    ...
    void volumeTextIsClampedAndFallsBackWhenIncomplete() {
        assertEquals(0, SettingsDialogController.parseVolumePercent("-5", 50));
        assertEquals(64, SettingsDialogController.parseVolumePercent("64", 50));
        assertEquals(100, SettingsDialogController.parseVolumePercent("250", 50));
        assertEquals(50, SettingsDialogController.parseVolumePercent("", 50));
        assertEquals(50, SettingsDialogController.parseVolumePercent("not a number", 50));
    }
